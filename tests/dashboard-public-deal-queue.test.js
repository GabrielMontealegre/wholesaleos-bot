...
(async () => {
  ...
  assert.ok(indexHtml.includes('/dashboard/wos-public-deals.js?v=33'), 'dashboard must load the Cycle 31 cache-busted public deals script');
  ...
  assert.ok(indexHtml.includes('/dashboard/wos-public-deals.js?v=33'), 'dashboard must load the current secure helper workbench');
