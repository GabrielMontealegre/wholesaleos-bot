...
(async () => {
  ...
  assert.ok(indexHtml.includes('/dashboard/wos-public-deals.js?v=34'), 'dashboard must load the Cycle 33 cache-busted public deals script');
  ...
  assert.ok(indexHtml.includes('/dashboard/wos-public-deals.js?v=34'), 'dashboard must load the current secure helper workbench');
