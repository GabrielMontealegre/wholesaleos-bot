...
(async () => {
  ...
  assert.ok(indexHtml.includes('/dashboard/wos-public-deals.js?v=35'), 'dashboard must load the Cycle 33.1 cache-busted public deals script');
  ...
  assert.ok(indexHtml.includes('/dashboard/wos-public-deals.js?v=35'), 'dashboard must load the current secure helper workbench');
