  ...
  try {
    ...
    for (let b = 0; b < batches; b++) {
      ...
      for (const rawLead of rawLeads) {
        ...
        const fullLead = { ...rawLead, arv: analysis.arv||0, offer: analysis.offer||0, repairs: analysis.repairs||0, fee_lo: analysis.fee_lo||10000, fee_hi: analysis.fee_hi||20000, risk: analysis.risk||'Medium', motivation: analysis.motivation||[] };
