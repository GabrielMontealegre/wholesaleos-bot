  ...
  try {
    ...
    job = Object.assign({}, job, {
      ...
      source_summary: {
        ...
        acquisition_core_source_ids_attempted: Array.isArray(acquisitionCoreResult.source_ids_attempted) ? acquisitionCoreResult.source_ids_attempted : [],
        acquisition_core_source_families_attempted: Array.isArray(acquisitionCoreResult.source_families_attempted) ? acquisitionCoreResult.source_families_attempted : [],
        ...
        acquisition_core_adapter_results: Array.isArray(acquisitionCoreResult.adapter_results) ? acquisitionCoreResult.adapter_results : [],
        acquisition_core_diagnostics: acquisitionCoreResult.diagnostics || {},
        acquisition_core_document_hunter_summary: acquisitionCoreResult.document_hunter_summary || {},
        acquisition_core_document_hunter_status: cleanText(acquisitionCoreResult.document_hunter_summary && acquisitionCoreResult.document_hunter_summary.search_provider_status),
        acquisition_core_document_hunter_readiness: cleanText(acquisitionCoreResult.document_hunter_summary && acquisitionCoreResult.document_hunter_summary.search_provider_readiness),
        acquisition_core_document_hunter_selected_provider: cleanText(acquisitionCoreResult.document_hunter_summary && acquisitionCoreResult.document_hunter_summary.search_provider_selected),
        acquisition_core_document_hunter_query_groups_used: Array.isArray(acquisitionCoreResult.document_hunter_summary && acquisitionCoreResult.document_hunter_summary.query_groups_used) ? acquisitionCoreResult.document_hunter_summary.query_groups_used : [],
        acquisition_core_document_hunter_search_results_found: Number(acquisitionCoreResult.document_hunter_summary && acquisitionCoreResult.document_hunter_summary.search_results_found || 0) || 0,
        acquisition_core_document_hunter_candidate_count: Number(acquisitionCoreResult.document_hunter_summary && acquisitionCoreResult.document_hunter_summary.candidate_count || 0) || 0,
        acquisition_core_document_hunter_discovered_url_count: Number(acquisitionCoreResult.document_hunter_summary && acquisitionCoreResult.document_hunter_summary.discovered_url_count || 0) || 0,
