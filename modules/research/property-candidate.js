...
function normalizePropertyCandidate(input, context) {
  ...
  const base = {
    ...
    reposted_source_date: cleanText(input.reposted_source_date),
    reposted_source_evidence_text: cleanText(input.reposted_source_evidence_text),
    reposted_source_url: cleanText(input.reposted_source_url),
    ...
    amount_or_judgment: cleanText(input.amount_or_judgment),
    unknown_source_amount: cleanText(input.unknown_source_amount),
    unknown_source_amount_evidence_text: cleanText(input.unknown_source_amount_evidence_text || input.amount_or_judgment_evidence_text),
    tax_due: cleanText(input.tax_due || input.tax_amount),
    tax_due_evidence_text: cleanText(input.tax_due_evidence_text || input.tax_amount_evidence_text),
    mortgage_arrears: cleanText(input.mortgage_arrears),
    mortgage_arrears_evidence_text: cleanText(input.mortgage_arrears_evidence_text),
    lien_amount: cleanText(input.lien_amount || input.tax_lien_amount),
    lien_amount_evidence_text: cleanText(input.lien_amount_evidence_text || input.tax_lien_amount_evidence_text),
    judgment_amount: cleanText(input.judgment_amount),
    judgment_amount_evidence_text: cleanText(input.judgment_amount_evidence_text),
    redemption_amount: cleanText(input.redemption_amount || input.delinquent_redemption_amount),
    redemption_amount_evidence_text: cleanText(input.redemption_amount_evidence_text || input.delinquent_redemption_amount_evidence_text),
    opening_bid: cleanText(input.opening_bid),
    opening_bid_evidence_text: cleanText(input.opening_bid_evidence_text),
    assessed_value: cleanText(input.assessed_value || input.appraised_value),
    assessed_value_evidence_text: cleanText(input.assessed_value_evidence_text || input.appraised_value_evidence_text),
    public_estimate: cleanText(input.public_estimate || input.estimated_value),
    public_estimate_evidence_text: cleanText(input.public_estimate_evidence_text || input.estimated_value_evidence_text),
    ...
    lifecycle_status: input.lifecycle_status && typeof input.lifecycle_status === 'object'
      ...
      : null,
    first_seen_at: cleanText(input.first_seen_at),
    last_seen_at: cleanText(input.last_seen_at),
    last_checked_at: cleanText(input.last_checked_at || input.source_checked_at || input.retrieved_at),
  ...
  candidate.distress_evidence = distressEvidenceModel.buildDistressEvidence(candidate);
...
function candidateToFindMeCard(candidate, context) {
  ...
  return {
    ...
    amount_or_judgment: candidate.amount_or_judgment,
    unknown_source_amount: candidate.unknown_source_amount,
    unknown_source_amount_evidence_text: candidate.unknown_source_amount_evidence_text,
    tax_due: candidate.tax_due,
    tax_due_evidence_text: candidate.tax_due_evidence_text,
    mortgage_arrears: candidate.mortgage_arrears,
    mortgage_arrears_evidence_text: candidate.mortgage_arrears_evidence_text,
    lien_amount: candidate.lien_amount,
    lien_amount_evidence_text: candidate.lien_amount_evidence_text,
    judgment_amount: candidate.judgment_amount,
    judgment_amount_evidence_text: candidate.judgment_amount_evidence_text,
    redemption_amount: candidate.redemption_amount,
    redemption_amount_evidence_text: candidate.redemption_amount_evidence_text,
    opening_bid: candidate.opening_bid,
    opening_bid_evidence_text: candidate.opening_bid_evidence_text,
    assessed_value: candidate.assessed_value,
    assessed_value_evidence_text: candidate.assessed_value_evidence_text,
    public_estimate: candidate.public_estimate,
    public_estimate_evidence_text: candidate.public_estimate_evidence_text,
    ...
    source_no_longer_listed: candidate.source_no_longer_listed,
    reposted_source_date: candidate.reposted_source_date,
    reposted_source_evidence_text: candidate.reposted_source_evidence_text,
    reposted_source_url: candidate.reposted_source_url,
    ...
    distress_evidence: candidate.distress_evidence,
